...
" HTML colors
hi htmlComment  	guifg=#66FF00 guibg=#000000 gui=none
hi htmlComment 		ctermfg=darkgray cterm=bold
hi htmlCommentPart	ctermfg=darkgray cterm=bold
hi htmlTag		ctermfg=lightgreen cterm=bold
hi htmlEndTag		ctermfg=lightgreen cterm=bold

" PHP colors
hi phpSpecialChar	ctermfg=white cterm=bold
